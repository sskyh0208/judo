...
public class PlayerManager
{
    ...
    public PlayerManager(string id, string nameKaki, string nameYomi, DateTime generateDt, int positionId, string placeId, string schoolId, int sense)
    {
        ...
        this.trainingMenu = new TrainingMenu();
    ...
    private int GenerateLimitStatuValue(int sense)
    {
        ...
        switch (sense)
        {
            ...
            case 4:
                ...
                break;
            case 5:
                valueWeight = GenerateRandomFloatValue(4, 8);
                break;
            case 6:
                valueWeight = GenerateRandomFloatValue(5, 9);
                break;
            case 7:
                valueWeight = GenerateRandomFloatValue(6, 10);
                break;
            case 8:
